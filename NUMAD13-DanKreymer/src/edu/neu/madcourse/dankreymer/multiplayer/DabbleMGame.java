...
public class DabbleMGame extends Activity {
	...
	private DabbleMView dabbleView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//start a new game
		if (bundle.getString(DabbleM.GAME_STATUS_KEY).equals(DabbleM.NEW_GAME)) 
		{
			selected = -1;
			score = 0;
			rand = new Random();
		...
		dabbleView = new DabbleMView(this);
	...
	protected void pauseGame()
	{
		...
		{
			pauseTimer();
			startActivity(new Intent(this, DabbleMPause.class));
		}
	...
	protected void gameOver()
	{
		...
		Intent i = new Intent(this, DabbleMGameOver.class);
