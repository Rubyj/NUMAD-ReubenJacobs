...
public class DabbleMTurnBasedView extends View {
	...
	private DabbleMTurnBasedGame dabbleGame;

	public DabbleMTurnBasedView(Context context) {
		super(context);
		dabbleGame = (DabbleMTurnBasedGame) context;
		setFocusable(true);
