...
public class DabbleComGame extends Activity {
	...
	private DabbleComView dabbleView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dabbleView = new DabbleComView(this);
	...
	{
		Intent i = new Intent(this, DabbleComHint.class);
	...
	protected void pauseGame()
	{
		...
		{
			pauseTimer();
			startActivity(new Intent(this, DabbleComPause.class));
		}
