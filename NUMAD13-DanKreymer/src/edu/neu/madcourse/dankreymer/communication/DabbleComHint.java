...
public class DabbleComHint extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		textBox.setText(bundle.getString(DabbleComGame.KEY_SOLUTION_1) + newline
				+ bundle.getString(DabbleComGame.KEY_SOLUTION_2) + newline
				+ bundle.getString(DabbleComGame.KEY_SOLUTION_3) + newline
				+ bundle.getString(DabbleComGame.KEY_SOLUTION_4));
	}

	@Override
	protected void onResume() {
		super.onResume();
		if (getIntent().getExtras().getBoolean(DabbleComGame.KEY_MUSIC))
		{
